...
public class FinalDb {
     ...
     * @param orderBy 排序的字段
     */
    public <T> List<T> findAll(Class<T> clazz, String orderColumn, String orderBy) {
        checkTableExist(clazz);
        return findAllBySql(clazz, SqlBuilder.getSelectSQL(clazz) + " ORDER BY " + orderColumn + " " + orderBy);
    }
     ...
     * @param orderBy 排序字段
     */
    public <T> List<T> findAllByWhere(Class<T> clazz, String strWhere, String orderColumn, String orderBy) {
        checkTableExist(clazz);
        return findAllBySql(clazz, SqlBuilder.getSelectSQLByWhere(clazz, strWhere) + " ORDER BY " + orderColumn + " "
                + orderBy);
    }
